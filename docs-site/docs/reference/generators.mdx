...
sidebar_position: 4
description: "Reference for ThoughtJack payload generators: nested JSON, garbage bytes, batch notifications, repeated keys, unicode spam, and ANSI escape sequences."
---
...
- [Use Payload Generators](/docs/how-to/use-generators) - practical guide to using generators in attack scenarios
- [Behavioral Modes](/docs/reference/behaviors) - delivery behaviors that modify how generator output is transmitted
- [OATF Document Schema](/docs/reference/config-schema) - full YAML reference including `$generate` directive
