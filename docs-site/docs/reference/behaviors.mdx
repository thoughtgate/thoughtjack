...
sidebar_position: 5
description: "Complete reference for ThoughtJack behavioral modes: slow-loris, unbounded-line, nested JSON delivery, and notification flood side effects."
---
...
- [Configure Delivery Behaviors](/docs/how-to/configure-behaviors) — practical guide to setting up delivery modes
- [Configure Side Effects](/docs/how-to/configure-side-effects) — practical guide to notification floods, pipe deadlocks, etc.
- [OATF Document Schema](/docs/reference/config-schema) — full YAML reference including behavior blocks
