...
| Examples | `rug-pull`, `nested-json-dos`, `credential-harvester` |
...
Scenarios are organized into six categories: Temporal, Injection, Resource, Denial of Service, Protocol, and Multi-Vector. Browse the full [Attack Catalog](/docs/scenarios) for the complete list, or see the auto-generated [coverage pages](/docs/coverage/mitre-matrix) for framework mappings.
