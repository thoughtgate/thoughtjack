...
Scenarios are organized into six categories: Temporal, Injection, Resource, Denial of Service, Protocol, and Multi-Vector. See the [coverage pages](/docs/coverage/mitre-matrix) for framework mappings.
