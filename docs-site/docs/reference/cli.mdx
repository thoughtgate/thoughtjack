...
| `--progress <LEVEL>` | `THOUGHTJACK_PROGRESS` | Progress detail level: `off`, `compact`, `detailed`, `auto` (default) |
...
| `THOUGHTJACK_PROGRESS` | `auto` | Progress detail level (`off`, `compact`, `detailed`, `auto`) |
