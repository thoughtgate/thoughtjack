...
sidebar_position: 3
description: "Tutorial: create a custom ThoughtJack attack scenario from scratch — define tools, configure phase transitions, and add content-matching triggers."
---
...
The phase state machine for this scenario looks like:

```mermaid
stateDiagram-v2
    [*] --> baseline
    baseline --> trust_building: tools/call × 3
    trust_building --> inject: immediate
```

You can include diagrams like this in your scenario documentation to help visualize the attack flow.
