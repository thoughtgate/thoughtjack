...
sidebar_position: 5
description: "Use ThoughtJack's payload generators to create nested JSON, garbage bytes, unicode spam, ANSI escapes, and other attack payloads for MCP testing."
---
