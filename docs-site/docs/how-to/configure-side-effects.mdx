...
sidebar_position: 4
description: "Configure ThoughtJack side effects: notification floods, batch amplification, pipe deadlocks, and connection termination for MCP resilience testing."
---
