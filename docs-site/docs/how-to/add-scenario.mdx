...
In traffic mode, connect your agent to `http://127.0.0.1:8080/mcp` to get a meaningful verdict. See [Test Agent Frameworks](/docs/how-to/agent-integration) for setup.
