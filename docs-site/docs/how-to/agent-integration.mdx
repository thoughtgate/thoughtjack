...
See the [Docker lab section in CLAUDE.md](https://github.com/thoughtgate/thoughtjack/blob/main/CLAUDE.md#docker-lab-real-llm-testing) for full lab documentation.
