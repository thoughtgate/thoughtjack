...
graph TD
    ...
    CLI --> Scenarios[Scenarios<br/>27 built-in attacks]
...
Built-in attack scenario (`rug-pull`) embedded at compile time via `include_str!`, plus 25 archived v0.2 scenarios under `scenarios/archive/`. Supports listing, detail display, fuzzy name matching, and YAML export.
