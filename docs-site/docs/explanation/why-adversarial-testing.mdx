...
ThoughtJack is an offensive testing tool. It simulates the attacker's side of the equation by:
...
Attack scenarios are authored as OATF (Open Agentic Testing Framework) documents — a declarative YAML format that describes the attack setup, phases, triggers, and success indicators. ThoughtJack executes these documents and produces a verdict: did the agent resist, or was it compromised?
