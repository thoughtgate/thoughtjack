...
sidebar_position: 4
description: "Why the Model Context Protocol is vulnerable to injection, temporal, and resource attacks — and how ThoughtJack models these attack vectors."
---
...
| Credential harvesting | Fake credential prompts in descriptions | `credential-harvester` |
...
| Escalation ladder | Benign responses → injection payload | `escalation-ladder` |
